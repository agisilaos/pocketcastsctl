...
// allowed to signal or persist managed local playback. Contexts bound preparation,
// lock acquisition, and state convergence; they never become the lifetime of a
// successfully committed player. State left by a naturally exited player is
// reconciled lazily on the next lifecycle operation.
//
